...
max_sm = None
for a, b in itertools.permutations(dataset, 2):
    sm = magnitude(add(a, b))
    if max_sm is None or sm > max_sm:
        max_sm = sm
# I suppose I could do the above loop as a one-liner using itertools,
# but I don't feel like it. :-P
